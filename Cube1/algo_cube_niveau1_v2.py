...
# Phase 1 : Demander à l'utilisateur de saisir un seul nombre pour cube1
while True:
    user_input = input("Entrez un nombre entre 0 et 999 pour cube1 : ")
    ...
    try:
        ...
        if 0 <= number < 1000:
            ...
            print("Le nombre doit être compris entre 0 et 999.")
    except ValueError:
...
# Phase 2 : Demander à l'utilisateur le nombre pour placer cube1 dans cube2
try:
